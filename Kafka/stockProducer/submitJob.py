...
# cmd = 'nohup python3 /home/leo/Desktop/Learnspace/DataEngineer/HashtagCashtag/Kafka/stockProducer/stockProducer.py '
cmd = 'nohup python3 /home/leo/Desktop/Learnspace/DataEngineer/HashtagCashtag/Kafka/stockProducer/stockProducerOneShot.py '
suffix = ' &'

def submitJob(stock, exchange):
    logFile = 'Log/log'+stock+'.txt'
